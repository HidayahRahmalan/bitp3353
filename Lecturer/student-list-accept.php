...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">View Finish Transfer Status</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
...
<div class="card">
    <div class="card-body">
        ...
        <p>List of Completed Course Transfer Status as Assessed by the Academic Advisor, TDA, and Dean.</p>
        ...
        <table class="table datatable">
            ...
            $query = "SELECT 
                        ...
                        GROUP BY 
                            s.stud_id, s.name, s.username, t.aa_status";
                    ...
                    ?>
                        ...
                        <tr>  
                           ...
                           <td><?php echo date('d/m/Y', strtotime($row['transfer_date'])); ?></td>
                            <td>
                                <button type="submit" class="btn btn-info"><a href="view-accept-transfer.php? statusid=<?php echo $row['stud_id']?>" class="text-light">VIEW</a></button>
                            </td>
                        </tr>
