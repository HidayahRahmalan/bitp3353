                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td style="color: <?php echo ($row['aa_status'] == 'Accepted' && $row['tda_status'] == 'Accepted' && $row['dean_status'] == 'Accepted') ? 'green' : 'blue'; ?>">
                                            ...
                                            ?>
                           </td>                              <td><?php echo date('d/m/Y', strtotime($row['transfer_date'])); ?></td>
                            <td>
                                <button type="submit" class="btn btn-info"><a href="tda-view-accept-transfer.php? statusid=<?php echo $row['stud_id']?>" class="text-light">VIEW</a></button>
                            </td>
                        </tr>
