...
// Get the teacher's club ID from the session
$teacherID = isset($_SESSION['userId']) ? $_SESSION['userId'] : null;
$query = "SELECT ClubID FROM registerteacher WHERE TeacherID = '$teacherID'";
$result = mysqli_query($conn, $query);

if (!$result) {
    die("Error retrieving teacher's club ID: " . mysqli_error($conn));
}
                      ...
                      <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        <tbody>
                          ...
                          $query = "SELECT rs.*, s.StudentName, c.ClubName, ct.ClubTypeName 
                                    ...
                                    WHERE rs.ClubId = '$teacherClubID' AND rs.Grade = '$Grade'
