...
if (isset($_POST['view'])) {
    $selectedFormLevel = $_POST['StudentFormLevel'];
}
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View Students by Form Level</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">View Students by Form Level</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Select Form Level</h6>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      <div class="col-xl-6">
                        ...
                        <select name="StudentFormLevel" class="form-control mb-3">
                          ...
                          <option value="1" <?php if(isset($selectedFormLevel) && $selectedFormLevel == '1') { echo "selected"; } ?>>1</option>
                          <option value="2" <?php if(isset($selectedFormLevel) && $selectedFormLevel == '2') { echo "selected"; } ?>>2</option>
                          <option value="3" <?php if(isset($selectedFormLevel) && $selectedFormLevel == '3') { echo "selected"; } ?>>3</option>
                          <option value="4" <?php if(isset($selectedFormLevel) && $selectedFormLevel == '4') { echo "selected"; } ?>>4</option>
                          <option value="5" <?php if(isset($selectedFormLevel) && $selectedFormLevel == '5') { echo "selected"; } ?>>5</option>
                        </select>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">All Students in Selected Form Level</h6>
                    </div>
                    <div class="table-responsive p-3">
                      <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        <tbody>
                          <?php
                          if (isset($selectedFormLevel) && !empty($selectedFormLevel) && $teacherClubID) {
                              $query = "SELECT registerstudent.RegisterStudentID, club.ClubName, student.StudentName, registerstudent.CurrentYear, registerstudent.StudentClass, registerstudent.StudentFormLevel, registerstudent.ClubPosition, clubtype.ClubTypeName
                                        ...
                                        WHERE registerstudent.StudentFormLevel = ? AND registerstudent.ClubID = ?
                                        ORDER BY CurrentYear DESC, StudentName ASC";
                              
                              // Prepare statement
                              $stmt = $conn->prepare($query);
                              $stmt->bind_param("ii", $selectedFormLevel, $teacherClubID);
                              $stmt->execute();
                              $rs = $stmt->get_result();
