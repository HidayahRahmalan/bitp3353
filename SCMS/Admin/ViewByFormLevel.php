                    ...
                    <div class="form-group row mb-3">
                      <div class="col-xl-6">
                        ...
                        <select name="StudentFormLevel" class="form-control mb-3">
                          ...
                          <option value="1" <?php if($selectedFormLevel == '1') { echo "selected"; } ?>>1</option>
                          <option value="2" <?php if($selectedFormLevel == '2') { echo "selected"; } ?>>2</option>
                          <option value="3" <?php if($selectedFormLevel == '3') { echo "selected"; } ?>>3</option>
                          <option value="4" <?php if($selectedFormLevel == '4') { echo "selected"; } ?>>4</option>
                          <option value="5" <?php if($selectedFormLevel == '5') { echo "selected"; } ?>>5</option>
                        </select>
                      </div>
                    </div>
                        ...
                        <tbody>
                          ...
                          if (isset($selectedFormLevel)) {
                              $query = "SELECT registerstudent.RegisterStudentID, club.ClubName, student.StudentName, registerstudent.CurrentYear, registerstudent.StudentClass, registerstudent.StudentFormLevel, registerstudent.ClubPosition, clubtype.ClubTypeName
                                        ...
                                        WHERE registerstudent.StudentFormLevel = '$selectedFormLevel'
