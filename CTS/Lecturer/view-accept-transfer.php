        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="student-list-accept.php"><i class="ri-arrow-left-line"></i>Back</a>
              ...
              <form class="row g-3">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $query = "SELECT DISTINCT c.course_code, c.title, g.similar, c.credit_hour,g.similar2,g.grade2, g.grade, t.aa_status, t.aa_comment, t.tda_status, t.tda_comment, t.dean_status, t.dean_comment
                              FROM transfer t
