...
<div class="card">
    <div class="card-body">
        ...
        <table class="table datatable">
            ...
            $query = "SELECT r.req_id, c.course_code, c.title, r.message, r.status, r.link, r.request_date 
                      FROM request r
...
<div class="card">
    <div class="card-body">
        ...
        <table class="table datatable">
            ...
            // Build the query with an optional WHERE clause
            $query = "SELECT r.req_id, c.course_code, c.title, r.message, r.status, r.link, r.request_date 
                      FROM request r
                      JOIN course c ON r.course = c.course_id";
