...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['overall_action'])) {
      ...
      $update_overall_query = "UPDATE transfer t
                              ...
                              SET t.dean_status = '$overall_status', t.dean_comment = '$overall_comment'
          ...
          <div class="card">
            <div class="card-body">
              <h1 class="card-title text-center">CREDIT EXEMPTION DETAILS</h1>
                ...
                <a href="dean-student-list.php"><i class="ri-arrow-left-line"></i>Back</a>
              ...
              <form class="row g-3">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $query = "SELECT DISTINCT c.course_code, c.title, g.similar, c.credit_hour,g.grade,g.similar2, g.grade2, t.dean_status, t.tda_comment
                              FROM transfer t
                              JOIN grade g ON t.grade_id = g.grade_id
                              JOIN course c ON g.course_id = c.course_id
                    ...
                    <tr>
                      ...
                      <td style="color: <?php
                        if ($row['dean_status'] == 'Accepted') {
                            echo 'green';
                        } elseif ($row['dean_status'] == 'Rejected') {
                            echo 'red';
                        } elseif ($row['dean_status'] == 'Pending') {
                            echo 'blue';
                        } else {
                            // Default color if none of the conditions match
                            echo 'black'; // or any other color you want to set
                        }
                    ?>;"><?php echo $row['dean_status']; ?></td>
                    </tr>
