    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="col-lg-12 breadcrumb-container">
                    ...
                    <h1 class="page-header">Remove Item</h1>
                            <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo "<tr class='gradeA'>
                                                ...
                                                <td><a href='deleteitemrecord.php?item_id=".$row['item_id']."' onclick='return confirmDelete();'><i class='fa fa-trash' style='color:red'></i></a></td>
                                            </tr>";
                                        }
                                        ?>
                                    </tbody>
