...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <h2 class="page-header printable">Inventory Report</h2>
                            <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <form id="searchForm" class="">
                        ...
                        <div class="form-group">
                            <label for="event_name">Select Item Name:</label>
        ...
        if (name) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#totalCount').html("Total Item: " + totalCount);
                },
