    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-12 breadcrumb-container">
                    ...
                    <h1 class="page-header">Add Lorry Details</h1>
                            <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="addedlorry.php" method="post">
                                     
                                        <div class="form-group">
                                            <label>Enter Plate Number</label>
                                            <input class="form-control" type="text" placeholder="PMS12382" name="plate_number" required>
                                        </div>
