    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-12 breadcrumb-container">
                    ...
                    <h1 class="page-header">Add Item Details</h1>
                            <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="addeditem.php" method="post" enctype="multipart/form-data">
                                     
                                        <div class="form-group">
                                            <label>Enter Item Name</label>
                                            <input class="form-control" type="text" placeholder="T-Shirt" name="item_name" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control"  name="item_image"  required="true">
                                        </div>
