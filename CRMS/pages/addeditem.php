                                    ...
                                    <?php
                                                ...
                                                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                                    ...
                                                    if (isset($_FILES['item_image']) && $_FILES['item_image']['error'] === UPLOAD_ERR_OK) {
                                                        ...
                                                        echo 'File upload error: ' . $_FILES['item_image']['error'];
                                                        exit();
                                                    }

                                                    if (empty($item_name) || empty($item_category)) {
                                                        echo "All fields are required!";
                                                        exit();
                                                    } else {
                                                        $qry = "CALL insert_item (?, ?, ?)";
                                                        $stmt = mysqli_prepare($conn, $qry);

                                                        if ($stmt) {
                                                            mysqli_stmt_bind_param($stmt, "sss", $item_name, $item_category, $item_image);
