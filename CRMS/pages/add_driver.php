...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <h1 class="page-header">Add Driver Details</h1>
                    <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="addeddriver.php" method="post">
                                     
                                        <div class="form-group">
                                            <label>Enter Driver Name</label>
                                            <input class="form-control" type="text" placeholder="Muhd Ali" name="name" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Phone number</label>
                                            <input class="form-control" placeholder="011-111111" name="phone_num" required>
                                        </div>
