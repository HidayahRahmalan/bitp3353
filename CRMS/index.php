    ...
    <body>
		...
		<nav class="navbar navbar-inverse">
			  <div class="container-fluid">
                ...
                <a class="navbar-brand" href="homepage.php">Clothes Recycle Management System</a>
				</div>
				...
				<ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="driver/driverlogin.php" ><span class="glyphicon glyphicon-user" style="color:#00A10F;"></span> Lorry Driver Login</a></li>
				</ul>
			  </div>
		</nav>
		 ...
		 <form action="#" method="post">
                            ...
                            <form role="form">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Admin ID" name="user" type="text" autofocus>
                                    </div>
                                    <div class="form-group">
			...
			<?php
                ...
                if (isset($_POST['login'])) {
                    $admin_id = mysqli_real_escape_string($con, $_POST['user']);
                    $password = mysqli_real_escape_string($con, $_POST['pass']);

                    // Hash the input password using SHA2
                    $hashed_password = hash('sha256', $password);

                    // Query to find the user with the given admin_id and hashed password
                    $query = mysqli_query($con, "SELECT * FROM admin WHERE admin_id='$admin_id' AND password='$hashed_password'");
