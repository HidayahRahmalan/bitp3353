                                ...
                                <div class="table-responsive">
                                    <table class="table table-primary table-striped align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            GROUP BY
                                                a.id, wp.name, c.userID, u.id, b.name, b.id, p.fullname, v.plateNo, v.model, v.color, a.date, a.start_time, a.end_time, a.status, py.amount, py.paymentMethod, py.paymentProofPath
                                            ORDER BY
                                                a.date, a.start_time
