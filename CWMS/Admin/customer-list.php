            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" class="btn btn-success btn-animation waves-effect waves-light" data-text="Add Customer" data-bs-toggle="modal" data-bs-target="#myModal"><span>Add Customer</span></button>
                                <br>
                                <br>
...
<tbody>
    ...
    $query = "SELECT 
                ...
                LEFT JOIN customer c ON p.user_id = c.userID
                LEFT JOIN appointment a ON c.id = a.custID
                LEFT JOIN washPackage wp ON a.washPackID = wp.id
                JOIN 
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $phone = $row['phone'];
            $email = $row['email'];
            $appointment_id = isset($row['appointment_id']) ? $row['appointment_id'] : 'No Appointment';
            $appointment_date = isset($row['appointment_date']) ? $row['appointment_date'] : '';
            $start_time = isset($row['start_time']) ? $row['start_time'] : '';
            $end_time = isset($row['end_time']) ? $row['end_time'] : '';
            $status = isset($row['status']) ? $row['status'] : '';
            $bname = isset($row['name']) ? $row['name'] : '';
            $pno = isset($row['plateNo']) ? $row['plateNo'] : '';
            ...
            <td>$phone</td>
            <td>$email</td>
            <td><button type='button' class='btn btn-info' data-bs-toggle='modal' data-bs-target='#viewModal$modal'>View</button></td>
            <td>
                <center>
                    <button type='button' class='btn btn-primary btn-animation waves-effect waves-light' data-bs-toggle='modal' data-bs-target='#updateModal$modal'>
                        Update
                    </button>
                    <a href='./Api/delete-customer.php?id=$user_id' class='btn btn-danger btn-animation waves-effect waves-light'>
                        Delete
                    </a>
                </center>
            </td>
        ...
        <!-- View Modal -->
<div class='modal fade' id='viewModal$modal' tabindex='-1' aria-labelledby='viewModalLabel$modal' aria-hidden='true'>
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class='modal-header'>
                <h5 class='modal-title' id='viewModalLabel$modal'>Appointment Details for $name</h5>
            ...
            <div class='modal-body'>
                ...
                <p><strong>Branch:</strong> $bname</p>
                <p><strong>Plate No:</strong> $pno</p>
    ...
    ";
            ...
            echo "
    <div id='view2$modal' class='modal fade' tabindex='-1'>
        <div class='modal-dialog'>
            <div class='modal-content'>
                <div class='modal-header'>
                ...
                <form method='post' action='Api/update-customer.php'>
                    <div class='modal-body'>
                        <div class='mb-3'>
    ...
    ";
        ...
        echo "<tr><td colspan='6' class='text-center text-danger'>No Customers Found</td></tr>";
    }
    ?>
</tbody>
</table>
...
<!-- END layout-wrapper -->
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel">Add Customer</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <?php
                include('../dbConnect.php');
                ...
                echo "
                    <form method='post' action='Api/add-employee.php'>
                        <div class='modal-body'>
                            <h5 class='fs-15'>
                            ...
                            <div class='col-md-12 mt-4'>
                                ...
                                <input type='text' class='form-control' name='position' value='customer' required>
                            </div>
                ...
                while ($branch_row = $branch_result->fetch_assoc()) {
                    $branch_value = $branch_row['id'];
                    $branch_display = $branch_row['name'];
