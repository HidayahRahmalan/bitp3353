            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" class="btn btn-success btn-animation waves-effect waves-light" data-text="Add Branch" data-bs-toggle="modal" data-bs-target="#myModal"><span>Add Branch</span></button>
                                <br>
                                <br>
