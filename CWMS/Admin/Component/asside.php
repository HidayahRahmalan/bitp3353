<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index.php" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="../cwms-logo.png" alt="logo"height="80">
                    <h4><b>CWMS</b></h4>
                </span>
                <span class="logo-lg">
                    <img src="../cwms-logo.png" alt="logo"height="80">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link menu-link" href="customer-list.php">
                        <i class="mdi mdi-account-multiple"></i> <span data-key="t-authentication">Customer</span>
                    </a>
                    <!-- <a class="nav-link menu-link" href="#">
