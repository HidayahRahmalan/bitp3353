...
<body>
    ...
    <div class="vehicled">
        <div class="vehicled-body">
            <button type="button" class="btn btn-success btn-animation waves-effect waves-light" data-text="Add Your vehicle" data-bs-toggle="modal" data-bs-target="#myModal">
                    ...
                    <tbody>
                        ...
                        if ($vehicle_result->num_rows > 0) {
                            while ($row = $vehicle_result->fetch_assoc()) {
                                ...
                                $model = $row['model'];
                                $color = $row['color'];
                                $image = base64_encode($row['image']);  // Convert binary data to base64
                                ...
                                echo "
                                    <tr>
                                        ...
                                        <td>$model</td>
                                        <td>$color</td>
                                        <td><img src='data:image/jpeg;base64,$image' alt='$model Image' width='100' height='60'></td>
                                        <td>
                                            <center>
                                                <button type='button' class='btn btn-primary btn-animation waves-effect waves-light' data-bs-toggle='modal' data-bs-target='#viewvehicle$modal'>
                                                    Update
                                                </button>
                                                <a href='./Api/vehicle-delete.php?id=$id' class='btn btn-danger btn-animation waves-effect waves-light'>
                                                    Delete
                                                </a>
                                            </center>
                                        </td>
                                ...
                                echo "
    <div id='viewvehicle$modal' class='modal fade' tabindex='-1'>
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <form method='post' action='Api/vehicle-update.php' enctype='multipart/form-data'>
                    <div class='modal-body'>
                        ...
                        <div class='mb-3'>
                            ...
                            <input type='text' class='form-control' name='plateNo' value='$plateNo' required>
                        </div>
                        <div class='mb-3'>
                        ...
                        <div class='mb-3'>
                            ...
                            <div class='mb-3'>
                                <img src='data:image/jpeg;base64," . $image . "' alt='$model Image' width='100' height='60'>
                            </div>
...
";
                            ...
                            echo "<tr><td colspan='7' class='text-center text-danger'>No vehicles Registered. Please register first.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
...
<div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="myModalLabel">Add Your Vehicle</h3>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
            </div>
            <form method='post' action='Api/vehicle-register.php' enctype="multipart/form-data">
                <div class='modal-body'>
                    <h5 class='fs-15'>
                    ...
                    <div class='col-md-12 mt-4'>
                        <label for='inputPlateNo' class='form-label'><strong>Plate No</strong></label>
        ...
        <div class="offcanvas-body p-0">
            <div data-simplebar class="h-100">
                <div class="p-4">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-check vehicled-radio">
                    ...
                    <div class="colorscheme-vehicledradio">
                        <div class="row">
                            <div class="col-4">
                                <div class="form-check vehicled-radio">
                            ...
                            <div class="col-4">
                                <div class="form-check vehicled-radio dark">
                    ...
                    <div id="sidebar-size">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-check sidebar-setting vehicled-radio">
                    ...
                    <div id="sidebar-color">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-check sidebar-setting vehicled-radio" data-bs-toggle="collapse" data-bs-target="#collapseBgGradient.show">
